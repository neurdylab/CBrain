...
EEG_BASE_DIR = "" # preprocessed EEG scans folder
EEG_MAT_DIR = "" # EEG mat files folder
FMRI_BASE_DIR = "" # fMRI ROI files folder
FMRI_SAVE_DIR = '' # fMRI subfolder name
EEG_INDEX_BASE_DIR = "" # Ground truth VIGALL

EEG_PROC_DIRS = [] # EEG scans names
FMRI_PROC_DIRS = [] # fMRI scans names
FMRI_PROC_DIRS_TRAIN = [] # fMRI training scans names
FMRI_PROC_DIRS_TEST = [] # fMRI testing scans names

EEG_SOURCE_FORMAT = '' # *.set
FMRI_SOURCE_FORMAT = '' # *.csv
EEG_INDEX_SOURCE_FORMAT = '' # .mat
EEG_FMRI_EVENT = '' # Event code

class EEGfMRIVuDatasetConfig(object):
    def __init__(self):
        self.default_value = 1
        self.num_classes = 2
        self.name = "eegfmri_vu"
        self.prediction_resolution = 575

class EEGfMRIVuDataset(Dataset):
    def __init__(
            self,
            dataset_config,
            split_set="train",
        ...
        for idx in range(len(self_scan_names)):
            ...
            eeg_scan_path = ... #TODO: scan paths
            fmri_scan_path = ... #TODO: scan paths
            eeg_index_path = ... #TODO: scan paths
            drop_list = ['time']
            ...
            df_eeg_data = df_eeg_data[:eeg_fmri_event[570][0]] 
            ...
            eeg_mat_path = ... #TODO: mat file paths
            eeg_mat = scipy.io.loadmat(eeg_mat_path)
